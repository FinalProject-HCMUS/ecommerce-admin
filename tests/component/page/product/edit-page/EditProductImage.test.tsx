...
import EditProductImage from '../../../../../src/components/page/product/edit-page/EditProductImage';
...
describe('EditProductImage', () => {
    ...
    it('renders upload UI and navigation buttons', () => {
        render(<EditProductImage {...baseProps} />);
    ...
    it('calls setFiles, setImages, setIndexThumbnail, setFormData, setDeletedProductImages when remove image is clicked', () => {
        const setFiles = vi.fn();
        const setImages = vi.fn();
        const setIndexThumbnail = vi.fn();
        const setFormData = vi.fn();
        const setDeletedProductImages = vi.fn();
        const props = {
            ...baseProps,
            images: [
                { id: '1', productId: 'p1', url: 'img1.png' },
        ...
        expect(setIndexThumbnail).toHaveBeenCalled();
        expect(setFormData).toHaveBeenCalled();
        expect(setDeletedProductImages).toHaveBeenCalled();
    });
    ...
    it('navigates next when next button is clicked', () => {
        ...
        const props = {
            ...baseProps,
            formData: { ...baseProps.formData, id: 'p1' },
        };
        render(<EditProductImage {...props} />);
        fireEvent.click(screen.getByText('next'));
        expect(navigate).toHaveBeenCalledWith('/products/edit/p1/variants');
    });
});